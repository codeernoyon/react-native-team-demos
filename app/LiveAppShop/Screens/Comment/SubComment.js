...
const MainComment = () => {
  return (
    <View style={tw`flex-row justify-end`}>
      <View style={tw`px-5 mt-3 flex-row w-[87%]`}>
        {/* -----===== user img ======------ */}
        <TouchableOpacity
          style={tw`relative h-10 w-10 rounded-full overflow-hidden bg-black mr-2`}
        >
          <Image
            source={{
        ...
        <View style={tw`flex-1`}>
          <View style={tw`bg-gray-200 rounded-md  px-4 py-4`}>
            ...
            {/* -----====== Comment Text ======----- */}
            <View style={tw`mt-3`}>
              <Text style={tw`text-[18px] font-semibold`}>prefect!</Text>
            </View>
          </View>
